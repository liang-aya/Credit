<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" style="width:100%">
      <el-table-column prop="loan_name" label="姓名" width="100" column-key="loan_name"></el-table-column>
      <el-table-column prop="loan_card" label="身份证" width="200"></el-table-column>
      <el-table-column prop="status" label="合同状态" width="200">
    ...
    downloadFile(url){
        ...
        xhr.onload = () =>{
            if(xhr.status == 200){
                ...
                this.savaAs(filename,xhr.response)
            }
        };
        xhr.send();
    },
